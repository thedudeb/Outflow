...
- **Next architecture gate:** Provision a non-production Supabase/Resend environment, apply all migrations and account functions, then prove cross-user RLS isolation, guest migration, invitation delivery/acceptance, two-browser conflict/Realtime behavior, and deletion before enabling accounts publicly or adding Stripe fulfillment.
