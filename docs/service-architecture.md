...
16. Signing out closes the cloud ledger and returns to the untouched local workspace. A pending cloud operation must first synchronize or be explicitly discarded so cloud snapshot data is not silently orphaned after logout.
