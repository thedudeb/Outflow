...
- Reminder timezone boundaries, concurrent-worker behavior, actual provider API failure, and Cron/Vault scheduling beyond the messaging-plane delivery, retry, idempotency, pause-scope, opt-out, refund, and signed bounce/complaint checks.
